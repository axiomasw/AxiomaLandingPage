...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <a
        href="https://wa.me/5492615880797" 
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#a78bfa] hover:bg-[#8b5cf6] rounded-full p-3 shadow-lg flex items-center justify-center"
        aria-label="WhatsApp"
      >
